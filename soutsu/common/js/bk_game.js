  ...
  $('#count').text($count);
    if($count) {
      ...
      if( 160 < ROLL_NUMVER && ROLL_NUMVER　<= 200 ){
        ...
        $mangaTitle.after('<p><img src="img/img_manga_03.jpg" alt="『ぼくのアイドル』"></p>');
