...
var Resources = {
    pokeball: '/soutsu/soutsuno/img/soustu-ball.png',
    pokeballActive: '/soutsu/soutsuno/img/soustu-ballactive.png',
    pokeballClosed: '/soutsu/soutsuno/img/soustu-ballclosed.png'
};
...
var Ball = {
    ...
    moveBall: function(x, y) {
        ...
        BallElement.style.top = Ball.y - 50 + 'px';
...
function animateCaptureState() {
    ...
    setTimeout(function() {
        ...
        if (seed < Math.floor(successRate)) {
            ...
            var captureStatus = document.getElementById('capture-status');
            captureStatus.innerHTML = "ゲェ~ン!<br>躁鬱くんは逃げ出した。";
            captureStatus.classList.toggle('hidden');
